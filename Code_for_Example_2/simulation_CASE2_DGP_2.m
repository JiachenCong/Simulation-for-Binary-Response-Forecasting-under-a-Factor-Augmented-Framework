...
disp(TTT)
writetable(TT, 'Results_CASE2_DGP_2.xlsx', 'Sheet','CASE2_DGP2','WriteRowNames', true);
writetable(TTT, 'Results_AUC_CASE2_DGP_2.xlsx', 'Sheet','CASE2_DGP2','WriteRowNames', true); 
t1 = toc;  % 计算经过的时间
