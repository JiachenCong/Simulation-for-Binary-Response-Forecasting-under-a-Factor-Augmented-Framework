...
disp(TTT)
writetable(TT, 'Results_CASE3_DGP_2.xlsx', 'Sheet','CASE3_DGP2','WriteRowNames', true);
writetable(TTT, 'Results_AUC_CASE3_DGP_2.xlsx', 'Sheet','CASE3_DGP2','WriteRowNames', true); 
t1 = toc;  % 计算经过的时间
