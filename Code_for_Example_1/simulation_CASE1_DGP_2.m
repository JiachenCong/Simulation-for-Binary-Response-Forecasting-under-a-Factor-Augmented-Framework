    ...
    for T=Time
        ...
        for k=1:R
            ...
            for t=1:T
                ...
                rho_e = 0.3;
                % 对应 DGP2 的 rho 值
                    E(t+1) = rho_e * E(t) + sqrt(1 - rho_e^2) * normrnd(0,1);  % 使用 AR(1) 模型生成误差项
...
disp(TTT)
writetable(TT, 'Results_CASE1_DGP_2.xlsx', 'Sheet','CASE1_DGP2','WriteRowNames', true);  
writetable(TTT, 'Results_AUC_CASE1_DGP_2.xlsx', 'Sheet','CASE1_DGP2','WriteRowNames', true);  
t1 = toc;  % 计算经过的时间
